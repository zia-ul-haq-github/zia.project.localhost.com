...
const CreateQualification = ( { visible, onVisiblityChange, onFinish, tutorID } ) => {
	...
	return (
		<ModalForm
            ...
            onFinish={async (values) => {
                ...
                /**
                 * Call the API to create the qualification
                 */
                ...
                */
                ...
                request('/api/qualifications', {
                    ...
                    if (api_response?.data?.id > 0) {
                        onFinish( {
							status: true,
							text_message: 'Qualification created successfully',
						} );
						...
						onFinish( {
							status: false,
							text_message:
								'Failed to create Qualification: Invalid response',
						} );
					}
